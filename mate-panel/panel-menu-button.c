...
//g_warning("- panel_menu_button_create_menu");
	...
	if (button->priv->use_menu_path          &&
	    ...
	    button->priv->path_root < LAST_MENU) {
		const char *filename;
//g_warning("- panel_menu_path_root_to_filename");
...
//g_warning("- gtk_menu_attach_to_widget");
...
static char *
 panel_menu_button_get_icon (PanelMenuButton *button)
 {
	...
	//g_warning("- panel_menu_button_get_icon");
...
//panel_menu_button_create_menu (button);
	if (!retval                     &&
	    ...
	    button->priv->menu_path     &&
	    panel_menu_button_create_menu (button)) {
	//g_warning("- panel_menu_button_get_icon - ok");
